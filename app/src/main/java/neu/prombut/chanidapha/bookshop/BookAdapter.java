...
/**
 * Created by iMac_14 on 6/21/2016 AD.
 */
public class BookAdapter extends BaseAdapter{

    //Explicit
    private Context context;
    private String[] iconStrings, nameStrings, priceString;

    public BookAdapter(Context context, String[] iconStrings, String[] nameStrings, String[] priceString) {
